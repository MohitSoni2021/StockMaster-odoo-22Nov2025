...
const Delivery = () => {
  ...
  const fetchDocuments = async () => {
    try {
      setLoading(true)
      const result = await documentAPI.getDocuments({ type: 'DELIVERY' })
      ...
      <div className='p-6'>
          ...
          <>
              ...
              <div className='bg-white p-6 rounded-lg shadow-md mb-8'>
                ...
                <form onSubmit={handleCreateDocument} className='space-y-4'>
                  ...
                  <div className='flex gap-2'>
                    ...
                    >
                      {submitLoading ? 'Creating...' : 'Create Delivery'}
                    </button>
                    <button
                      type='button'
                      onClick={() => setShowCreateForm(false)}
            ...
            <div className='bg-white p-6 rounded-lg shadow-md'>
              ...
              {loading ? (
                ...
                <p className='text-gray-500 text-center py-8'>No deliveries created yet.</p>
              ) : (
        ...
        {activeTab === 'detail' && selectedDocument && (
          <div className='space-y-6'>
            <div className='bg-white p-6 rounded-lg shadow-md'>
              <div className='flex justify-between items-center mb-4'>
                <h2 className='text-xl font-semibold'>Delivery #{selectedDocument.reference}</h2>
                <button
                  onClick={() => {
