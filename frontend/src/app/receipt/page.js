...
const Receipt = () => {
  ...
  const fetchDocuments = async () => {
    try {
      setLoading(true)
      const result = await documentAPI.getDocuments({ type: 'RECEIPT' })
  ...
  return (
    <div>
      <Navbar />
      <div className='p-6'>
        <h1 className='text-2xl font-bold mb-6'>Receipt Management</h1>
          ...
          <>
              ...
              <div className='bg-white p-6 rounded-lg shadow-md mb-8'>
                ...
                <form onSubmit={handleCreateDocument} className='space-y-4'>
                  ...
                  <div className='flex gap-2'>
                    ...
                    >
                      {submitLoading ? 'Creating...' : 'Create Receipt'}
                    </button>
                    <button
                      type='button'
                      onClick={() => setShowCreateForm(false)}
            ...
            <div className='bg-white p-6 rounded-lg shadow-md'>
              ...
              {loading ? (
                ...
                <p className='text-gray-500 text-center py-8'>No receipts created yet.</p>
              ) : (
        ...
        {activeTab === 'detail' && selectedDocument && (
          <div className='space-y-6'>
            <div className='bg-white p-6 rounded-lg shadow-md'>
              <div className='flex justify-between items-center mb-4'>
                <h2 className='text-xl font-semibold'>Receipt #{selectedDocument.reference}</h2>
                <button
                  onClick={() => {
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 pb-6 border-b'>
                ...
                <div>
                  <p className='text-sm text-gray-500'>From (Contact)</p>
                  <p className='text-lg font-medium'>{selectedDocument.from?.name || '-'}</p>
                </div>
                <div>
